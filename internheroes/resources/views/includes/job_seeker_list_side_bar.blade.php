<div class="col-md-3 col-sm-12"> 
    ...
    <div class="sidebar">
        ...
        <!-- Jobs By State -->
        <div class="widget">
            <h4 class="widget-title">{{__('By Province')}}</h4>
            <ul class="optionlist view_more_ul">
                        ...
                        @if(null !== $state)
                            ...
                            @if($key <= 3)
                                <li>
                                    ...
                                    {{$state->state}} <span>{{App\User::countNumJobSeekers('state_id', $state->state_id)}}</span> 
                                </li>
                            @endif
                        @endif
                    @endforeach
        ...
        <div class="widget">
           <!--  <h4 class="widget-title">{{__('Salary Range')}}</h4>
            <div class="form-group">
                {!! Form::number('current_salary', Request::get('current_salary', null), array('min'=>'0','class'=>'form-control', 'id'=>'current_salary', 'placeholder'=>__('Current Salary'))) !!}
            </div>
            <div class="form-group">
                {!! Form::number('expected_salary', Request::get('expected_salary', null), array('min'=>'0','class'=>'form-control', 'id'=>'expected_salary', 'placeholder'=>__('Expected Salary'))) !!}
            </div> -->
            <!-- <div class="form-group">
            ...
            <!-- button -->
            <div class="searchnt"> 
                <button type="submit" class="btn btn-secondary round"><i class="fa fa-filter" aria-hidden="true"></i> {{__('Filter Seekers')}}</button>
            </div>
            <!-- button end--> 
        </div>
        <!-- Side Bar end --> 

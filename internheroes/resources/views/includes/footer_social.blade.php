...
<a class="facebook" href="{{ $siteSetting->facebook_address }}" target="_blank"><i class="fa fa-facebook" aria-hidden="true"></i></a>
@endif
@if ((string)$siteSetting->twitter_address !== '')
<a class="twitter" href="{{ $siteSetting->twitter_address }}" target="_blank"><i class="fa fa-twitter" aria-hidden="true"></i></a>
@endif
@if ((string)$siteSetting->instagram_address !== '')
<a class="instagram" href="{{ $siteSetting->instagram_address }}" target="_blank"><i class="fa fa-instagram" aria-hidden="true"></i></a>
@endif
@if ((string)$siteSetting->google_plus_address !== '')
<a class="google" href="{{ $siteSetting->google_plus_address }}" target="_blank"><i class="fa fa-google-plus" aria-hidden="true"></i></a>
@endif
...
<a class="linkedin" href="{{ $siteSetting->linkedin_address }}" target="_blank"><i class="fa fa-linkedin-square" aria-hidden="true"></i></a>
@endif

<h5 onclick="showSkills();">{{__('Skills')}}
        <a href="javascript:;" onclick="showProfileSkillModal();" class="btn btn-primary round float-right"> 
                <i class="fa fa-plus-circle"></i>  {{__('Add Skill')}} 
        </a>
</h5>
<div class="row">
    <div class="col-md-12">

<h5 onclick="showEducation();">
        {{__('Education')}} 
        <a href="javascript:;" onclick="showProfileEducationModal();" class="btn btn-primary round float-right"> 
...
<script type="text/javascript">
    ...
    function initdatepicker(){
        ...
        $(".datepicker-experience-start").datepicker({
                autoclose: true,
                format:'yyyy-m-d'
        }).on('changeDate', function (selected) {
                var minDate = new Date(selected.date.valueOf());
                $('.datepicker-experience-end').datepicker('setStartDate', minDate);
        });
        $(".datepicker-experience-end").datepicker({
                format:'yyyy-m-d'
        }) 
        .on('changeDate', function (selected) {
                var maxDate = new Date(selected.date.valueOf());
                $('.datepicker-experience-start').datepicker('setEndDate', maxDate);
        });;

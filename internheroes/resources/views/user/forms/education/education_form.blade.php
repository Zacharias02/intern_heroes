<div class="modal-body">
    <div class="form-body">
        ...
        <div class="formrow" id="div_degree_title">
            <input required class="form-control" id="degree_title" placeholder="" name="degree_title" type="text" value="{{(isset($profileEducation)? $profileEducation->degree_title:'')}}">
        ...
        <div class="formrow" id="div_state_id">
            <span id="default_state_education_dd">
                {!! Form::select('state_id', [''=>__('Select Province')], null, array('class'=>'form-control', 'id'=>'education_state_id')) !!}
            </span>
        ...
        <div class="formrow" id="div_institution">
            <input required class="form-control" id="institution" name="institution" type="text" value="{{(isset($profileEducation)? $profileEducation->institution:'')}}">
        ...
        <div class="formrow" id="div_degree_result">
            <input required class="form-control" id="degree_result" placeholder="" name="degree_result" type="text" value="{{(isset($profileEducation)? $profileEducation->degree_result:'')}}">
            <label>{{__('Degree Result')}}</label>           

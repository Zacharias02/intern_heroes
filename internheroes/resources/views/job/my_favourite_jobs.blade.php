...
@include('includes.inner_page_title', ['page_title'=>__('Favourite Internships')])
    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-md-9 col-sm-8"> 
                <div class="myads">
                    <h3>{{__('Favourite Internships')}}</h3>
                    <ul class="searchList">
                        <!-- job start --> 
                    ...
                    @if(count($jobs) <= 0)
                        <div class="empty-state">
                            ...
                            <h4 class="empty-state-title">You don't have favourite internships yet</h4>
                            <p></p>
                        </div>
                    @endif
                </div>

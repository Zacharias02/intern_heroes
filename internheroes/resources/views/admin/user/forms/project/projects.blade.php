        ...
        <div class="col-md-12">
            <div class="portlet light portlet-fit bordered">
                <div class="portlet-title">
                    <div class="caption"> <i class=" icon-layers font-green"></i> <span class="caption-subject font-green bold uppercase">Portfolio</span> </div>
                </div>
...
<script type="text/javascript">
        ...
        $("#add_project_modal").modal({backdrop: 'static'});

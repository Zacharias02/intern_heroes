...
<script type="text/javascript">
    ...
    $("#add_experience_modal").modal({backdrop: 'static'});
    ...
    filterDefaultCitiesExperience(0);
        ...
        $('#experience_country_id').on('change', function (e) {
            e.preventDefault();
            filterDefaultStatesExperience(0);
        });
        $(document).on('change', '#experience_state_id', function (e) {
            e.preventDefault();
            filterDefaultCitiesExperience(0);
        ...
        filterDefaultStates(<?php echo old('experience_state_id', (isset($user)) && (int) $user->experience_state_id > 0 ? $user->experience_state_id : $siteSetting->default_state_id); ?>);

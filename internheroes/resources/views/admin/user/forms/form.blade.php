        ...
        <div class="col-md-6 col-sm-6 col-xs-12">
            <div class="form-group {!! APFrmErrHelp::hasError($errors, 'image') !!}">
                <div class="fileinput fileinput-new" data-provides="fileinput" align="center">
                    <div class="fileinput-new thumbnail" style="clip-path: circle(50% at 50% 50%); border:none !important;">
                    @if(isset($user))
                    {{ ImgUploader::print_image("user_images/$user->image") }}  
                    <!-- <span style="background-image: url({{ asset('/') }}user_images/{{$user->image}})" class="img_profile"></span> -->
                    @else
                        <img src="{{ asset('/') }}admin_assets/no-image.png" alt="" class="circle-thumbnail"/> 
                        <!-- <span style="background-image: url({{ asset('/') }}admin_assets/no-image.png)"></span> -->
                    @endif
                </div>
                    <div class="fileinput-preview fileinput-exists thumbnail" style="max-width: 200px; max-height: 150px;border:none !important;"> </div>
                    <div> <span class="btn default btn-file"> <span class="fileinput-new"> Select Profile Image </span> <span class="fileinput-exists"> Change </span> {!! Form::file('image', null, 'accept', array('id'=>'image', 'accept')) !!} </span> <a href="javascript:;" class="btn red fileinput-exists" data-dismiss="fileinput"> Remove </a> </div>
                </div>
...
<!--         @if(isset($user))
    ...
    <div class="input-group {!! APFrmErrHelp::hasError($errors, 'password') !!} col-md-12"> 
        {!! Form::label('password', 'Password', ['class' => 'bold']) !!}
            {!! Form::password('password', array('class'=>'form-control', 'id'=>'password', 'placeholder'=>'Password')) !!}
            {!! APFrmErrHelp::showErrors($errors, 'password') !!}
            <div class="input-group-btn" style="right:34.2px; top:25px; position: absolute; z-index: 1000;">
                <button class="btn btn-default" type="button" onclick="showPassword()" id="showpass"><i class="glyphicon glyphicon-eye-open" id="picon"></i></button>
            </div>
    </div>
    <br>

    <div class="form-group {!! APFrmErrHelp::hasError($errors, 'father_name') !!}">
        {!! Form::label('father_name', 'Father Name', ['class' => 'bold',  'hidden'=>'on']) !!}                    
        {!! Form::hidden('father_name', null, array('class'=>'form-control', 'id'=>'father_name', 'placeholder'=>'Father Name','value'=>'null')) !!}
    ...
    <div class="formrow {!! APFrmErrHelp::hasError($errors, 'date_of_birth') !!}"> 
        ...
        {!! Form::label('date_of_birth', 'Date of Birth', ['class' => 'bold']) !!} 
        {!! Form::text('date_of_birth', $date_of_birth, array('class'=>'form-control datepicker', 'id'=>'date_of_birth', 'placeholder'=>'Date of Birth', 'autocomplete'=>'off')) !!}
        {!! APFrmErrHelp::showErrors($errors, 'date_of_birth') !!} 
    </div>
    ...
    <div class="form-group {!! APFrmErrHelp::hasError($errors, 'national_id_card_number') !!}">
        {!! Form::label('national_id_card_number', 'Valid Government ID #', ['class' => 'bold']) !!}                    
        {!! Form::text('national_id_card_number', null, array('class'=>'form-control', 'id'=>'national_id_card_number', 'placeholder'=>'Valid Government ID #')) !!}
        {!! APFrmErrHelp::showErrors($errors, 'national_id_card_number') !!}                                       
    </div>
    <div class="form-group hidden {!! APFrmErrHelp::hasError($errors, 'country_id') !!}">
    ...
    <div class="form-group {!! APFrmErrHelp::hasError($errors, 'phone') !!}">
        ...
        {!! Form::text('phone', null, array('class'=>'form-control', 'id'=>'phone', 'placeholder'=>'Phone Number', 'minlength'=>'7', 'maxlength'=>'14')) !!}
    ...
    <div class="form-group {!! APFrmErrHelp::hasError($errors, 'mobile_num') !!}">
        ...
        {!! Form::text('mobile_num', null, array('class'=>'form-control', 'id'=>'mobile_num', 'placeholder'=>'Mobile Number','maxlength'=>'11', 'title'=>'Please insert a valid mobile number')) !!}
    ...
    <div class="form-group {!! APFrmErrHelp::hasError($errors, 'current_salary') !!}">
        ...
        {!! Form::text('current_salary', null, array('class'=>'form-control', 'id'=>'current_salary', 'placeholder'=>'Current Salary', 'maxlength'=>'6', 'minlength'=>'5')) !!}
    ...
    <div class="form-group {!! APFrmErrHelp::hasError($errors, 'expected_salary') !!}">
        ...
        {!! Form::text('expected_salary', null, array('class'=>'form-control', 'id'=>'expected_salary', 'placeholder'=>'Expected Salary', 'maxlength'=>'6', 'minlength'=>'5')) !!}
    ...
    <div class="form-group {!! APFrmErrHelp::hasError($errors, 'salary_currency') !!}">
        ...
        {!! Form::text('salary_currency', null, array('class'=>'form-control', 'id'=>'salary_currency', 'placeholder'=>'Salary Currency', 'autocomplete'=>'off','maxlength'=>'6', 'minlength'=>'5', 'title'=>'Please Enter A Valid Number')) !!}
    ...
    <div class="form-group {!! APFrmErrHelp::hasError($errors, 'street_address') !!}">
        ...
        {!! Form::textarea('street_address', null, array('class'=>'form-control textarea-size', 'id'=>'street_address', 'placeholder'=>'Street Address')) !!}
    ...
    <div class="form-group {!! APFrmErrHelp::hasError($errors, 'is_immediate_available') !!}">
        ...
        <div class="radio-list">
            ...
            <label class="radio-inline">
                ...
                <span class="v-align-center">Immediate Available</span>
            </label>
            <label class="radio-inline">
                <input id="not_immediate_available" name="is_immediate_available" type="radio" value="0" {{$is_immediate_available_2}}>
                <span class="v-align-center">Not Immediate available</span>
            </label>
        </div>
    ...
    <div class="form-group {!! APFrmErrHelp::hasError($errors, 'verified') !!}">
        ...
        <div class="radio-list">
            ...
            <label class="radio-inline">
                ...
                <span class="v-align-center">Verified</span>
            </label>
            <label class="radio-inline">
                <input id="not_verified" name="verified" type="radio" value="0" {{$verified_2}}>
                <span class="v-align-center">Not Verified</span>
            </label>
        </div>
    ...
    @else
        {!! Form::button('Add User <i class="fa fa-arrow-circle-right" aria-hidden="true"></i>', array('class'=>'btn btn-large btn-primary', 'type'=>'submit')) !!}
    @endif
</div>
{!! Form::close() !!}
@push('css')
...
<script type="text/javascript">
    $(document).ready(function () {
        ...
        $("div > img").addClass("circle-thumbnail");
        filterDefaultStates(<?php echo old('state_id', (isset($user)) && (int) $user->state_id > 0 ? $user->state_id : $siteSetting->default_state_id); ?>);
    });
...
/*     $('#first_name,#middle_name').bind('keypress', function (event) {
    ...
    $('#phone,#mobile_num').bind('keypress', function (event) {
    ...
    $('input[type="file"] > #cv_file'). attr("accept", "application/pdf,application/docx,application/csv");
</script>
@endpush
                                    ...
                                    <thead>
                                        <tr role="row" class="filter">
                                            ...
                                            <td>
                                                ...
                                                {!! Form::select('country_id', ['' => 'Select Country']+$countries, $default_country_id, array('id'=>'country_id', 'class'=>'form-control hidden')) !!}
...
<script>
    $(function () {
        ...
        filterDefaultStates(<?= $siteSetting->default_state_id ?>);
    });

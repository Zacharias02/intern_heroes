...
<div class="form-body">        
    ...
    <div class="hidden form-group {!! APFrmErrHelp::hasError($errors, 'country_id') !!}" id="country_id_div">
    ...
    <div class="hidden form-group {!! APFrmErrHelp::hasError($errors, 'state_id') !!}" id="state_id_div">
    ...
    <div class="form-group {!! APFrmErrHelp::hasError($errors, 'salary_from') !!}" id="salary_from_div">
        {!! Form::label('salary_from', 'Offered Salary From', ['class' => 'bold']) !!}                    
    ...
    <div class="form-group {!! APFrmErrHelp::hasError($errors, 'salary_to') !!}" id="salary_to_div">
        {!! Form::label('salary_to', 'Offered Salary To', ['class' => 'bold']) !!}                    
        {!! Form::number('salary_to', null, array('class'=>'form-control', 'id'=>'salary_to')) !!}
        {!! APFrmErrHelp::showErrors($errors, 'salary_to') !!}                                       
    </div>
    <div class="form-group hidden {!! APFrmErrHelp::hasError($errors, 'salary_currency') !!}" id="salary_currency_div">
        {!! Form::label('salary_currency', 'Salary Currency', ['class' => 'bold']) !!}                    
        {!! Form::select('salary_currency', ['' => 'Select Salary Currency']+$currencies, $siteSetting->default_currency_code, array('class'=>'form-control', 'id'=>'salary_currency')) !!}
    ...
    <div class="form-group {!! APFrmErrHelp::hasError($errors, 'num_of_positions') !!}" id="num_of_positions_div">
        {!! Form::label('num_of_positions', 'Number of Available Positions', ['class' => 'bold']) !!}                    
    ...
    <!-- <div class="form-group {!! APFrmErrHelp::hasError($errors, 'expiry_date') !!}">
        {!! Form::label('expiry_date', 'Job Post Expiration Date', ['class' => 'bold']) !!}
    ...
    <div class="formrow {!! APFrmErrHelp::hasError($errors, 'expiry_date') !!}"> 
        <?php $expiry_date = \Carbon\Carbon::parse((isset($user) && $user->expiry_date != '') ? $user->expiry_date: '')->format('Y-m-d'); ?> 
        {!! Form::label('expiry_date', 'Job Post Expiration Date', ['class' => 'bold']) !!} 
        {!! Form::text('expiry_date', $expiry_date, array('class'=>'form-control datepicker', 'id'=>'expiry_date', 'placeholder'=>'Job Post Expiration Date', 'autocomplete'=>'off')) !!}
        {!! APFrmErrHelp::showErrors($errors, 'expiry_date') !!} 
    </div>
    ...
    <div class="form-actions">
        <?php $button_label = (isset($job))?'Update':'Add' ?>
...
<script type="text/javascript">
    $(document).ready(function () {
        ...
        filterDefaultStates(<?php echo old('state_id', (isset($job)) ? $job->state_id : $siteSetting->default_state_id); ?>);
    });
    ...
    $('#salary_from,#salary_to').bind('keypress', function (event) {

            ...
            <tr>
                <td align="center" valign="top" bgcolor="#24140e" style="background-color:#fff;"><!-- 600px container (white background) -->
                    <table border="0" cellpadding="0" cellspacing="0" class="container" style="width:100%;border: solid 1px #d6d4d4;">
                        <tr>
                            <td class="content" align="left" style="padding-top:0px;background-color:#f8f8f8;"><table border="0" cellpadding="0" cellspacing="0" class="force-row" style="width:100%;">
                                    <tr>
                        ...
                        <tr style="background-color: #fff;">
                            <td class="container-padding footer-text" align="left" style="font-family:Helvetica, Arial, sans-serif;font-size:12px;line-height:16px;color:#aaaaaa;padding: 20px 20px;">
                               <!--  <div class=" social"> 
                                ...
                                <br> -->
                                <span class="ios-footer" style=" text-align:center;display: block;"> © Copyright {{ date('Y')}} {{ $siteSetting->site_name }} - All Rights Reserved </span>
                            </td>
                        </tr>
                    </table>
                    <!--/600px container --></td>

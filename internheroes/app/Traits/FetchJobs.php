...
trait FetchJobs
{
    ...
    public function fetchAllIdsArray($is_featured = -1, $field = 'jobs.id',$state_ids = array(), $search = '', $job_titles = array(), $company_ids = array(), $industry_ids = array(), $job_skill_ids = array(), $functional_area_ids = array(), $country_ids = array(), $city_ids = array(), $is_freelance = -1, $career_level_ids = array(), $job_type_ids = array(), $job_shift_ids = array(), $gender_ids = array(), $degree_level_ids = array(), $job_experience_ids = array(), $salary_from = 0, $salary_to = 0, $salary_currency = '')
    {
    ...
    public function createQuery($query, $search = '', $job_titles = array(), $company_ids = array(), $industry_ids = array(), $job_skill_ids = array(), $functional_area_ids = array(), $country_ids = array(), $state_ids = array(), $city_ids = array(), $is_freelance = -1, $career_level_ids = array(), $job_type_ids = array(), $job_shift_ids = array(), $gender_ids = array(), $degree_level_ids = array(), $job_experience_ids = array(), $salary_from = 0, $salary_to = 0, $salary_currency = '', $is_featured = -1)
    {
        ...
        if (isset($industry_ids[0])) {
            ...
            if (isset($company_ids[0]) && isset($company_ids_array[0])) {
                ...
                $query->whereIn('jobs.functional_area_id', $industry_ids);
            }
        }
        ...
        if ($search != '') {
            ...
            /* $query = $query->where("MATCH (`search`) AGAINST ('$search*' IN BOOLEAN MODE)"); */
        }

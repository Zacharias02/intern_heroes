        ...
        if (isset($user) && count($user->profileSkills)):
            foreach ($user->profileSkills as $skill):
                ...
                $html .= '<tr id="skill_' . $skill->id . '">
						<td><span class="text">' . $skill->getJobSkill('job_skill') . '</span></td>
            ...
            $html .= '<!--Project Start-->
                    <div class="col-md-12">
                        <h4 class="text-center mb-4 text-empty">No specified skills.<h4>
                    </div>
                <!--Project End-->';
        endif;
    ...
    public function showApplicantProfileSkills(Request $request, $user_id)
    {
        ...
        if (isset($user) && count($user->profileSkills)):
            foreach ($user->profileSkills as $skill):
                ...
                $html .= '<tr id="skill_' . $skill->id . '">
						<td><span class="text">' . $skill->getJobSkill('job_skill') . '</span></td>
						<td><span class="text">' . $skill->getJobExperience('job_experience') . '</span></td></tr>';
            endforeach;
        else:
            $html .= '</table>';
            $html .= '<!--Project Start-->

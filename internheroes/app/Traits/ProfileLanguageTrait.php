        ...
        if (isset($user) && count($user->profileLanguages)):
            foreach ($user->profileLanguages as $language):
                ...
                $html .= '<tr id="language_' . $language->id . '">
						<td><span class="text">' . $language->getLanguage('lang') . '</span></td>
						<td><span class="text">' . $language->getLanguageLevel('language_level') . '</span></td>
            ...
            $html .= '<!--Project Start-->
                    <div class="col-md-12">
                        <h4 class="text-center mb-4 text-empty">No languages specified.<h4>
                    </div>
                <!--Project End-->';
        endif;
    ...
    public function showApplicantProfileLanguages(Request $request, $user_id)
    {
        ...
        if (isset($user) && count($user->profileLanguages)):
            foreach ($user->profileLanguages as $language):
                ...
                $html .= '<tr id="language_' . $language->id . '">
						<td><span class="text">' . $language->getLanguage('lang') . '</span></td>
						<td><span class="text">' . $language->getLanguageLevel('language_level') . '</span></td></tr>';
            endforeach;
        else:
            $html .= '</table>';
            $html .= '<!--Project Start-->

        ...
        if (isset($user) && count($user->profileExperience)):
            ...
            <div class="col-md-12" id="experience_' . $experience->id . '">
              <div class="mt-element-ribbon bg-grey-steel">
                ...
                ' . $experience->date_start->format('d M, Y') . ' - ' . $date_end . ' | ' . $experience->getCity('city') . ', ' . $experience->getState('state') . '<br />
            ...
            $html .= '<!--Project Start-->
                    <div class="col-md-12">
                        <h4 class="text-center mb-4 text-empty">No experiences yet.<h4>
                    </div>
                <!--Project End-->';
        endif;
        ...
        if (isset($user) && count($user->profileExperience)):
            foreach ($user->profileExperience as $experience):
                ...
                $html .= '<div class="panel panel-info" id="experience_' . $experience->id . '">
						  ...
						  <p class="text-left">' . $experience->date_start->format('d M, Y') . ' - ' . $date_end . ' | ' . $experience->getCity('city') . ', ' . $experience->getState('state') . '</p>
    ...
    public function showApplicantProfileExperience(Request $request, $user_id)
    {
        ...
        if (isset($user) && count($user->profileExperience)):
            foreach ($user->profileExperience as $experience):
                ...
                $html .= '<li>
                <div class="row">
                  <div class="col-md-2 hidden"><img src="' . asset('images/work-experience.png') . '" alt="work experience"></div>
                  <div class="col-md-12">
                    <h4>' . $experience->title . '</h4>
                    <div class="row">
                      <div class="col-md-12">
                        <h5>' . $experience->company . ' | ' . $experience->getCity('city') . ', ' . $experience->getState('state') . '</h5>
                        <span class="sub"> From ' . $experience->date_start->format('d M, Y') . ' - ' . $date_end . '</span>

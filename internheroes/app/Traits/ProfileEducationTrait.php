        ...
        if (isset($user) && count($user->profileEducation)):
            ...
            <div class="col-md-12" id="education_' . $education->id . '">
              <div class="mt-element-ribbon bg-grey-steel">
                ...
                ' . $education->date_completion . ' | ' . $education->getCity('city') . ', ' . $education->getState('state') . '<br />
                ' . $majorSubjects . '<br/>
            ...
            $html .= '<!--Project Start-->
                    <div class="col-md-12">
                        <h4 class="text-center mb-4 text-empty">No educational attainment specified.<h4>
                    </div>
                <!--Project End-->';
        endif;
        ...
        if (isset($user) && count($user->profileEducation)):
            foreach ($user->profileEducation as $education):
                ...
                $html .= '<div class="panel panel-info" id="education_' . $education->id . '">
						  ...
						  <p class="text-left">' . $education->date_completion . ' | ' . $education->getCity('city') . ', ' . $education->getState('state') . '</p>
						  <p class="text-left">' . $majorSubjects . '<br/>' . $education->institution . '</p>
						  </div>
    ...
    public function showApplicantProfileEducation(Request $request, $user_id)
    {
        ...
        if (isset($user) && count($user->profileEducation)):
            foreach ($user->profileEducation as $education):
                ...
                $majorSubjects = $education->getProfileEducationMajorSubjectsStr();
                $html .= '<li>
                <div class="date hidden">' . $education->date_completion . '<br/>' . $education->getCity('city') . '</div>
                <div class="row">
                    <div class="col-md-12">
                        <h4>' . $education->getDegreeLevel('degree_level') . ' in ' . $education->degree_title . /*  ' - ' . $education->getDegreeType('degree_type') .  */'</h4>
                        <div class="row">
                            <div class="col-md-12">
                                <h5>' . $education->date_completion . ' | ' . $education->getCity('city') . ', ' . $education->getState('state') . '</h5>

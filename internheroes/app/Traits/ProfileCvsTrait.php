...
trait ProfileCvsTrait
{
        ...
        if (isset($user) && count($user->profileCvs)):
            ...
            foreach ($user->profileCvs as $cv):
                ...
                $html .= '<tr id="cv_' . $cv->id . '">
                                ...
                                <td><span class="text">' . $default . '</span></td>
            ...
            $html .= '<!--Project Start-->
                    <div class="col-md-12">
                        <h4 class="text-center mb-4 text-empty">No uploaded Cv.<h4>
                    </div>
                <!--Project End-->';
        endif;
    ...
    private function assignValues($profileCv, $request, $user_id)
    {
        ...
        $file_name = $this->uploadCvFile($request);

        if(!empty($file_name)){
            $profileCv->cv_file = $file_name;
        }

        ...
        switch ($this->method()) {
            ...
            case 'POST': {
                    ...
                    return [
                        "id" => "",
                        "company_id" => "required",
                        "title" => "required|alpha_spaces|max:180",
                        ...
                        "salary_from" => 'required|max:8'/*.(int)$this->input('salary_to')*/,
                        "salary_to" => 'required|max:8'/*.(int)$this->input('salary_from')*/,

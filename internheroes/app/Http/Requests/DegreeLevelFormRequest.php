    ...
    public function rules()
    {
        switch ($this->method()) {
            ...
            case 'POST': {
                    ...
                    return [
                        "id" => "", "lang" => "required", "degree_level" => "required|max:150|alpha_spaces|unique:degree_levels$degree_level_unique", "is_default" => "required", "degree_level_id" => "required_if:is_default,0", "is_active" => "required",
                    ];
                }
            default:break;
        }

    ...
    public function rules()
    {
        switch ($this->method()) {
            ...
            case 'POST': {
                    ...
                    return [
                        "id" => "", "lang" => "required", "degree_level_id" => "required", "degree_type" => "required|max:150|alpha_spaces|unique:degree_types$degree_type_unique", "is_default" => "required", "degree_type_id" => "required_if:is_default,0", "is_active" => "required",
                    ];
                }
            default:break;
        }

    ...
    public function rules()
    {
        switch ($this->method()) {
            ...
            case 'POST': {
                    ...
                    return [
                        "id" => "", "lang" => "required", "major_subject" => "required|max:150|alpha_spaces|unique:major_subjects$major_subject_unique", "is_default" => "required", "major_subject_id" => "required_if:is_default,0", "is_active" => "required",
                    ];
                }
            default:break;
        }

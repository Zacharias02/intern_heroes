...
class SiteSettingController extends Controller
{
    ...
    public function updateSiteSetting(SiteSettingFormRequest $request)
    {
        ...
        $siteSetting->listing_page_vertical_ad_2 = $request->input('listing_page_vertical_ad_2');
        $siteSetting->listing_page_vertical_ad_3 = $request->input('listing_page_vertical_ad_3');
        ...
        $siteSetting->facebook_app_secret = $request->input('facebook_app_secret');

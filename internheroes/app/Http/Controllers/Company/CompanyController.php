...
class CompanyController extends Controller
{
    ...
    public function updateCompanyProfile(CompanyFrontFormRequest $request)
    {
        ...
        $company->facebook = (false === strpos($request->input('facebook'), 'http')) ? 'https://' . $request->input('facebook') : $request->input('facebook');
        $company->twitter = (false === strpos($request->input('twitter'), 'http')) ? 'https://' . $request->input('twitter') : $request->input('twitter');  
        $company->linkedin = (false === strpos($request->input('linkedin'), 'http')) ? 'https://' . $request->input('linkedin') : $request->input('linkedin');
        $company->google_plus = (false === strpos($request->input('google_plus'), 'http')) ? 'https://' . $request->input('google_plus') : $request->input('google_plus');
        $company->pinterest = (false === strpos($request->input('pinterest'), 'http')) ? 'https://' . $request->input('pinterest') : $request->input('pinterest');
